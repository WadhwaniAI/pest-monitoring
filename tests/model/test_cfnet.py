...
class ModelTestCase(unittest.TestCase):
    """Class to check the working of CFNet Model"""
    ...
    def test_fast_dev_run_with_vgg_with_adam(self):
        ...
        config_name = (
            "tests/helpers/resources/configs/model/cfnet/test-vgg_backbone-adam_optimizer.yaml"
        )
    ...
    def test_fast_dev_run_with_resnet_with_adam(self):
        """Tests fast dev run over model class"""
        config_name = (
            "tests/helpers/resources/configs/model/cfnet/test-resnet_backbone-adam_optimizer.yaml"
        )
        model_config = OmegaConf.load(config_name)
        model: LightningModule = instantiate(
            model_config.model,
    ...
    def test_fast_dev_run_with_vgg_with_sgd(self):
        """Tests fast dev run over model class"""
        config_name = (
            "tests/helpers/resources/configs/model/cfnet/test-vgg_backbone-sgd_optimizer.yaml"
        )
        model_config = OmegaConf.load(config_name)
        model: LightningModule = instantiate(
            model_config.model,
    ...
    def test_fast_dev_run_with_resnet_with_sgd(self):
        """Tests fast dev run over model class"""
        config_name = (
            "tests/helpers/resources/configs/model/cfnet/test-resnet_backbone-sgd_optimizer.yaml"
        )
        model_config = OmegaConf.load(config_name)
        model: LightningModule = instantiate(
            model_config.model,
    ...
    def test_fast_dev_run_with_vgg_with_adam_with_schedular(self):
        """Tests fast dev run over model class"""
        config_name = (
            "tests/helpers/resources/configs/model/cfnet/"
    ...
    def test_model_predict_outputs_with_vgg(self):
        ...
        model_output = model.network.predict(input_images)
        network_output = network.predict(input_images)
