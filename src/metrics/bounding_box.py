...
class BoundingBox:
    ...
    Inspired by
    https://github.com/rafaelpadilla/review_object_detection_metrics/blob/main/src/bounding_box.py
    """
    ...
    def __init__(
        ...
        img_size : tuple (optional)
            Image size in the format (width, height)=>(int, int) representing the size of the
        ...
        # If YOLO format (rel_x_center, rel_y_center, rel_width, rel_height),
        # change it to absolute format (x,y,w,h)
    ...
    def set_coordinates(self, coordinates, type_coordinates, img_size=None):
        """Set the coordinates of the bounding box based
        on the format of the coordinates as passed in type_coordinates.
    ...
    def __str__(self):
        ...
        return (
            ...
            f" (X1Y1X2Y2): {abs_bb_xyx2y2}\narea: {area}\nbb_type: {self._bb_type}"
        )

    def __eq__(self, other):
        """Check if two BB objects are equal."""
    ...
    def get_union_areas(boxA, boxB, interArea=None):
        ...
        boxB : BoundingBox
            Bounding box object.
        interArea : int
            If fixed intersection area is already known, it can be passed as an argument.
        """
    ...
    def get_amount_bounding_box_all_classes(bounding_boxes, reverse=False):
        """Get the amount of bounding boxes for each class.
        ...
        reverse : bool
            If True, the results will be sorted in descending order.
        """
    ...
    def get_bounding_box_by_class(bounding_boxes, class_id):
        """Get the bounding boxes of a given class.
    ...
    def get_bounding_boxes_by_image_name(bounding_boxes, image_name):
        """Get the bounding boxes of a given image.
    ...
    def get_total_images(bounding_boxes):
        """Get the number of images that contain bounding boxes.
